...
class PyHeat(hass.Hass):
    ...
    def initialize(self):
        ...
        self.boiler = BoilerController(self, self.config, self.alerts, self.valve_coordinator, self.trvs, app_ref=self)
        self.setpoint_ramp = SetpointRamp(self, self.config, app_ref=self)
